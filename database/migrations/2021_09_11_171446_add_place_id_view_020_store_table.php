...
class AddPlaceIdView020StoreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('view_020_stores', function (Blueprint $table) {
            \DB::statement('DROP VIEW view_020_stores');
            \DB::statement(
                'CREATE VIEW view_020_stores AS
                SELECT
                    stores.id AS id,
                    ...
                    stores.address_id AS address_id,
                    stores.place_id AS place_id,
